...
// This contract locks zenlink liquidity tokens. Used to give investors peace of mind a token team has locked liquidity
// and that the zenlink tokens cannot be removed from zenlink until the specified unlock date has been reached.
...
contract CeresLiquidityLocker is Ownable, ReentrancyGuard {
   ...
   */
    function lockLPToken(address _lpToken, uint256 _amount, uint256 _unlock_date, bool _fee_option, address payable _user) external nonReentrant {
        ...
        // ensure this pair is a zenlink pair by querying the factory
        ...
        require(factoryPairAddress == address(_lpToken), 'NOT ZENLINK PAIR');
